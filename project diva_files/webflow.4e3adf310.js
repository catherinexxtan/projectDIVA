        ...
        D = l(function (e) {
          function n() {
            var t,
              ...
              i,
              r = u.length;
            if (r) for (I(n), e = $(), t = r; t--; ) (i = u[t]) && i.render(e);
          }
      ...
      (t.exports = function (t, e) {
        ...
        function k(e, n) {
          ...
          r.el.off(h),
            ...
            _(r),
            s
              ? (r.el.on("setting" + h, C(r)), z(r), (r.hasTimer = !1))
              : (r.el.on("swipe" + h, C(r)),
                ...
                r.config.autoplay &&
                  !r.hasTimer &&
                  ((r.hasTimer = !0), (r.timerCount = 1), S(r)),
        ...
        function C(n) {
          return function (r, a) {
            ...
            if (s && "setting" === r.type) {
              ...
              if ((_(n), $(n), null == a.select)) return;
              !(function (n, i) {
                var r = null;
                i === n.slides.length && (g(), $(n)),
              ...
              if (n.nav.has(r.target).length) {
                ...
                if (
                  ...
                  switch (r.keyCode) {
                    ...
                    case o.ARROW_LEFT:
                    case o.ARROW_UP:
                      R(n.nav, Math.max(c - 1, 0)), r.preventDefault();
                      break;
                    case o.ARROW_RIGHT:
                    case o.ARROW_DOWN:
                      R(n.nav, Math.min(c + 1, n.pages)), r.preventDefault();
                      break;
                    case o.HOME:
